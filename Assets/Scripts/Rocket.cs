...
public class Rocket : MonoBehaviour {
	...
	void OnTriggerEnter (){
		...
		explosionEffectClone = (Transform) Instantiate (explosionEffect, transform.position, Quaternion.identity);
		print(explosionEffectClone.GetComponent<Die>().timeToLive);
